...
\noindent\subparagraph{Ein \textit{Framework}} definiert eine Architektur für Anwendungen und stellt Komponenten bereit, mit welchen das Entwickeln einer Anwendung erleichtert sein soll. \cite{johnson1988} 
...
\begin{figure}[tbt]
	...
	\end{center}
	\caption[Alte Architektur von React Native]{Alte Architektur von React Native \protect \footnotemark}
...
\begin{figure}[tbt]
	...
	\end{center}
	\caption[Neue Architektur von React Native]{Neue Architektur von React Native \protect \footnotemark}
